...
from app.api.v1.endpoints import auth, cash_cut, users, roles, clients, repairs, repair_types, payments, payment_types, repair_status, whatsapp, store, material, repair_complexity, garment, repair_comments, attendance
...
api_router.include_router(cash_cut.router, prefix="/cash-cut", tags=["CashCut"])
